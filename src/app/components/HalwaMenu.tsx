...
interface HalwaMenuProps {
  ...
  scrollToMenu?: () => void; // optional, but we do call it if provided
}
...
export default function HalwaMenu({ halwaData, scrollToMenu }: HalwaMenuProps) {
  ...
  const handlePaginationClick = (index: number) => {
    ...
    // Safely call the parent function if it exists
    scrollToMenu?.();
  };
          ...
          >
            ...
            <div className="flex items-center justify-center border-2 border-[#ba9256] p-6 rounded-t-full min-h-[75vh]">
              <div className="text-center">
                <h2 className="text-xl uppercase font-luloClean">
                  {currentHalwa.name}
                </h2>
                <p className="text-lg mt-4 font-afacad">
                ...
                return (
                  <div key={size} className="flex flex-col items-center my-6">
                    <div className="flex items-center justify-center gap-4">
                      <p className="font-bold font-luloCleanBold">
                        {weightOption.weight}
                      </p>
                      <div className="h-6 w-[2px] bg-[#ba9256]" />
                      <p className="font-luloClean">
                    ...
                    <div className="flex items-center justify-center gap-2 my-2">
                      ...
                      <p className="text-md font-afacad">
